...
namespace Hospital_services.Migrations
{
    ...
    [Migration("20240401222712_isdeleted_set_to_false")]
    partial class isdeleted_set_to_false
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hospital.entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hospital.entities.Medicine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hospital.entities.Category", b =>
                {
                    b.HasOne("Hospital.entities.Category", "Parent")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("Hospital.entities.Medicine", b =>
                {
                    b.HasOne("Hospital.entities.Category", "Category")
                        .WithMany("Medicine")
            ...
            modelBuilder.Entity("Hospital_entities.Inventory", b =>
                {
                    b.HasOne("Hospital.entities.Medicine", "Medicine")
                        .WithMany()
